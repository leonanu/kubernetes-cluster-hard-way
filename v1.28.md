...
docker load --input ./release-v3.27.3/images/calico-cni.tar 
docker load --input ./release-v3.27.3/images/calico-kube-controllers.tar
docker load --input ./release-v3.27.3/images/calico-node.tar
vi ./release-v3.27.3/manifests/calico.yaml
```
...
```shell
cp ./release-v3.27.3/bin/calicoctl/calicoctl-linux-amd64 /usr/local/bin/kubectl-calico
```
