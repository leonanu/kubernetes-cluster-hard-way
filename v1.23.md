...
* v0
* [下载](https://github.com/etcd-io/etcd/releases/tag/v3.5.2)
...
```shell
for I in {1..3};do
    rsync -avr /usr/local/src/etcd-v3.5.2-linux-amd64 root@v${I}:/opt/app/
    ssh root@v${I} "chown -R root.root /opt/app/etcd-v3.5.2-linux-amd64; ln -snf /opt/app/etcd-v3.5.2-linux-amd64 /opt/etcd"
done
```
...
* [下载](https://github.com/projectcalico/calicoctl/releases/download/v3.22.1/calicoctl) calicoctl
