...
* [下载](https://github.com/containernetworking/plugins/releases/download/v1.1.0/cni-plugins-linux-amd64-v1.1.0.tgz) CNI-Plugins
...
```shell
tar xzvf cni-plugins-linux-amd64-v1.1.0.tgz -C ./cni-plugins
```
...
```shell
for I in {1..6};do
    ssh root@v${I} "mkdir -p /opt/app/cni-plugins-linux-amd64-v1.1.0/bin && ln -snf /opt/app/cni-plugins-linux-amd64-v1.1.0 /opt/cni"
