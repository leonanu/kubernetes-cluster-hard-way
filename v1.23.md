...
* [下载](https://github.com/containerd/containerd/releases/download/v1.6.11/containerd-1.6.11-linux-amd64.tar.gz) Containerd
...
```shell
tar xzvf containerd-1.6.11-linux-amd64.tar.gz -C ./containerd
```
...
for I in {1..6};do
    ...
    ssh root@v${I} "mkdir -p /opt/app/containerd-1.6.11-linux-amd64/bin && ln -snf /opt/app/containerd-1.6.11-linux-amd64 /opt/containerd"
