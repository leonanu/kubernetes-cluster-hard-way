...
* [下载](https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.26.3/crictl-v1.26.3-linux-amd64.tar.gz) crictl
...
```shell
tar xzvf crictl-v1.26.3-linux-amd64.tar.gz
```
...
for I in {1..6};do
    ...
    ssh root@v${I} "mkdir -p /opt/app/crictl-v1.26.3-linux-amd64/bin && ln -snf /opt/app/crictl-v1.26.3-linux-amd64 /opt/crictl"
