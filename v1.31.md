...
* [下载](https://github.com/opencontainers/runc/releases/download/v1.2.2/runc.amd64) RunC
...
for I in {1..6};do
    ...
    ssh root@v${I} "mkdir -p /opt/app/runc-v1.2.2-linux-amd64/sbin && ln -snf /opt/app/runc-v1.2.2-linux-amd64 /opt/runc"
