...
ExecStart=/opt/etcd/etcd \\
  ...
  --client-cert-auth \\
  --listen-peer-urls=https://172.31.31.71.24.0 \\
  --initial-advertise-peer-urls=https://172.31.31.71.24.0 \\
  --listen-client-urls=https://172.31.31.71:2379,http://127.0.0.1:2379 \\
  --advertise-client-urls=https://172.31.31.71:2379 \\
  --initial-cluster-token=etcd-cluster-0 \\
  --initial-cluster="v1=https://172.31.31.71.24.0,v2=https://172.31.31.72:2380,v3=https://172.31.31.73:2380" \\
...
* [下载](https://github.com/cri-o/cri-o/releases/tag/v1.24.0#downloads)
...
* [下载](https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.24.1/crictl-v1.24.1-linux-amd64.tar.gz) crictl
...
```shell
tar xzvf crictl-v1.24.1-linux-amd64.tar.gz
```
...
for I in {1..6};do
    ...
    ssh root@v${I} "mkdir -p /opt/app/crictl-v1.24.1-linux-amd64/bin && ln -snf /opt/app/crictl-v1.24.1-linux-amd64 /opt/crictl"
